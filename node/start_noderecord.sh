...
DAEMON_ARGS="/home/pi/speech_to_text/record_stream.js"               # path to your node.js server/app
...
LOCAL_VAR_RUN=/home/forever            # in case the init script is run by non-root user, you need to
